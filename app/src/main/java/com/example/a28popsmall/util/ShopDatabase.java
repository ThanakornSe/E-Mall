...
import com.example.a28popsmall.data.CartItemDao;
import com.example.a28popsmall.data.GroceryItemDao;
    ...
    private static RoomDatabase.Callback sRoomDatabaseCallback = new RoomDatabase.Callback(){
        ...
        public void onCreate(@NonNull SupportSQLiteDatabase db) {
            databaseWriteExecutor.execute(new Runnable() {
                @Override
                public void run() {
                    GroceryItemDao groceryItemDao = instance.groceryItemDao();
                    ...
                    allItems.add(new GroceryItem("Ice Cream", "Ice cream (derived from earlier iced cream or cream ice) is a sweetened frozen food typically eaten as a snack or dessert. It may be made from dairy milk or cream and is flavoured with a sweetener, either sugar or an alternative, and any spice, such as cocoa or vanilla.",
                            "https://s.isanook.com/jo/0/rp/r/w700/ya0xa0m1w0/aHR0cDovL2ltYWdlLmpvb3guY29tL0pPT1hjb3Zlci8wLzQyYjUyZjIzZjMzMDU2NGQvNjQwLmpwZw==.jpg",
                            "Food", 5.4, 10));
